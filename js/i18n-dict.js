...
window.GG_I18N_DICT = {
    ...
    en: {
        ...
        'rules.intro2':            'In multiplayer, you rate the others — whoever scores highest wins the round!',
        ...
        'solo.cat_random':         'Random',
        'solo.cat_negative':       'Film negative',
        'solo.cat_digital':        'Digital',
        'solo.category_hint':      'pick a medium',
        'solo.challenge':          'challenge',
        'solo.chall_random':       'Random',
        'solo.challenge_hint':     'sign in to unlock photos',
        /* Dynamic strings built by solo-setup.js — {n}/{total} are replaced at runtime */
        'solo.chall_randompick':   'random pick',
        'solo.catlabel_all':       'all categories',
        'solo.catlabel_negative':  'negative',
        'solo.catlabel_digital':   'digital',
        'solo.chall_hint_empty':   'no challenges in this category yet — try another',
        'solo.chall_hint_locked':  'play a few rounds to unlock specific challenges in this category',
        'solo.chall_hint_progress':'{n} / {total} unlocked in this category',
        'solo.cat_hint_one':       '{n} photo in this category',
        'solo.cat_hint_many':      '{n} photos in this category',
        ...
        'contributors.intro_html':         "The game exists thanks to the photographers who trusted us with their work. Each of them keeps <strong>all rights</strong> on their images. If you like their work, go support them! And if you'd like to take part too, fill in the form below.",
        ...
        'contributors.cta_body_html':      "Send us your work so we can add it to the game. You need to provide at least a “raw” version and your final version. Your rights stay yours.",
    ...
    fr: {
        ...
        'rules.intro2':            'En multijoueur, vous notez les autres, celui qui obtient la meilleure note remporte la partie !',
        ...
        'solo.cat_random':         'Aléatoire',
        'solo.cat_negative':       'Négatif argentique',
        'solo.cat_digital':        'Digital',
        'solo.category_hint':      'choisissez un médium',
        'solo.challenge':          'challenge',
        'solo.chall_random':       'Aléatoire',
        'solo.challenge_hint':     'connectez-vous pour débloquer des photos',
        'solo.chall_randompick':   'tirage aléatoire',
        'solo.catlabel_all':       'toutes catégories',
        'solo.catlabel_negative':  'négatif',
        'solo.catlabel_digital':   'numérique',
        'solo.chall_hint_empty':   'aucun challenge dans cette catégorie pour l’instant — essayez-en une autre',
        'solo.chall_hint_locked':  'jouez quelques parties pour débloquer des challenges spécifiques dans cette catégorie',
        'solo.chall_hint_progress':'{n} / {total} débloqués dans cette catégorie',
        'solo.cat_hint_one':       '{n} photo dans cette catégorie',
        'solo.cat_hint_many':      '{n} photos dans cette catégorie',
        ...
        'contributors.intro_html':         "Le jeu existe grâce aux photographes qui ont confié leur travail. Chacun garde <strong>tous ses droits</strong> sur ses images. Si leur travail vous plaît, allez les soutenir ! Et si vous voulez y participer vous aussi, remplissez le formulaire ci-dessous.",
        ...
        'contributors.cta_body_html':      "Envoyez-nous votre travail pour qu’il soit ajouté au jeu. Vous devez au moins fournir une version « brute » et votre version finale. Vos droits restent les vôtres.",
    ...
    it: {
        ...
        'rules.intro2':            'In multigiocatore, voti gli altri — chi ottiene il punteggio più alto vince la partita!',
        ...
        'solo.cat_random':         'Casuale',
        'solo.cat_negative':       'Negativo analogico',
        'solo.cat_digital':        'Digitale',
        'solo.category_hint':      'scegli un medium',
        'solo.challenge':          'sfida',
        'solo.chall_random':       'Casuale',
        'solo.challenge_hint':     'accedi per sbloccare foto',
        'solo.chall_randompick':   'scelta casuale',
        'solo.catlabel_all':       'tutte le categorie',
        'solo.catlabel_negative':  'negativo',
        'solo.catlabel_digital':   'digitale',
        'solo.chall_hint_empty':   'ancora nessuna sfida in questa categoria — provane un’altra',
        'solo.chall_hint_locked':  'gioca qualche partita per sbloccare sfide specifiche in questa categoria',
        'solo.chall_hint_progress':'{n} / {total} sbloccate in questa categoria',
        'solo.cat_hint_one':       '{n} foto in questa categoria',
        'solo.cat_hint_many':      '{n} foto in questa categoria',
        ...
        'contributors.intro_html':         "Il gioco esiste grazie ai fotografi che hanno affidato il loro lavoro. Ognuno conserva <strong>tutti i diritti</strong> sulle proprie immagini. Se il loro lavoro ti piace, vai a sostenerli! E se vuoi partecipare anche tu, compila il modulo qui sotto.",
        ...
        'contributors.cta_body_html':      "Mandaci il tuo lavoro perché venga aggiunto al gioco. Devi fornire almeno una versione « grezza » e la tua versione finale. I tuoi diritti restano tuoi.",
    ...
    es: {
        ...
        'rules.intro2':            'En multijugador, puntúas a los demás — ¡quien saca la mejor nota gana la partida!',
        ...
        'solo.cat_random':         'Aleatorio',
        'solo.cat_negative':       'Negativo analógico',
        'solo.cat_digital':        'Digital',
        'solo.category_hint':      'elige un medio',
        'solo.challenge':          'desafío',
        'solo.chall_random':       'Aleatorio',
        'solo.challenge_hint':     'inicia sesión para desbloquear fotos',
        'solo.chall_randompick':   'elección aleatoria',
        'solo.catlabel_all':       'todas las categorías',
        'solo.catlabel_negative':  'negativo',
        'solo.catlabel_digital':   'digital',
        'solo.chall_hint_empty':   'aún no hay desafíos en esta categoría — prueba otra',
        'solo.chall_hint_locked':  'juega algunas rondas para desbloquear desafíos específicos en esta categoría',
        'solo.chall_hint_progress':'{n} / {total} desbloqueados en esta categoría',
        'solo.cat_hint_one':       '{n} foto en esta categoría',
        'solo.cat_hint_many':      '{n} fotos en esta categoría',
        ...
        'contributors.intro_html':         "El juego existe gracias a los fotógrafos que confiaron su trabajo. Cada uno conserva <strong>todos los derechos</strong> sobre sus imágenes. Si te gusta su trabajo, ¡ve a apoyarlos! Y si tú también quieres participar, rellena el formulario de abajo.",
        ...
        'contributors.cta_body_html':      "Envíanos tu trabajo para que lo añadamos al juego. Debes proporcionar al menos una versión « en bruto » y tu versión final. Tus derechos siguen siendo tuyos.",
